...
Read in the text file with the scan function.Scanning the data shows that there are 407 lines. The character function returns the character value, while the new line is used as a seperator. Store the in the variable,<i>lines</i>.
